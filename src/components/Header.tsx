...
import { Sparkles, Code2, Bookmark, Newspaper } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-colors border border-slate-200/70"
            title="웹앱 구현 및 API 연동 가이드"
          >
            <Code2 className="w-3.5 h-3.5 text-indigo-600" />
            <span className="hidden xs:inline">구현 가이드</span>
          </button>
